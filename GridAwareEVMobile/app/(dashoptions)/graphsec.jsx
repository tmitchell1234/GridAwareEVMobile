  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerText}>Graph Sections</Text>
      </View>

      <View style={styles.buttonContainer}>
        <LinearGradient colors={['#FF6F3C', '#4E64FF']} style={styles.gradientButton}>
          <TouchableOpacity style={styles.sectionButton}>
            <Text style={styles.buttonText}>Charge Halting History</Text>
          </TouchableOpacity>
        </LinearGradient>

        <LinearGradient colors={['#4E64FF', '#FF6F3C']} style={styles.gradientButton}>
          <TouchableOpacity style={styles.sectionButton}>
            <Text style={styles.buttonText}>Electrical Measurements Graph</Text>
          </TouchableOpacity>
        </LinearGradient>
      </View>
    </SafeAreaView>
